...
fn_vocab = data_dir + '/vocab.pkl'
fn_corpus = data_dir+ '/corpus.pkl'
fn_flatnd = data_dir+ '/flattened.npy'
fn_docids = data_dir+ '/doc_ids.npy'
fn_vectors = data_dir+ '/vectors.npy'
...
power = float(os.getenv('power', 0.55))
